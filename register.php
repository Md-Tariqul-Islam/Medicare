                                ...
                                <div class="p-5">
                                    ...
                                    <form action="register.php" method="post">
                                        ...
                                        <div class="form-group m-4">
                                            <input type="text" name="lName" class="form-control rounded-pill p-2" placeholder="Enter Username..." required>
                                        </div>

                                        <div class="form-group m-4">
                                            <input type="email" name="lemail" class="form-control rounded-pill p-2 "placeholder="Enter Email Address..." required>
                                                <?php 
                                                if($error!=null){
                                        ...
                                        <div class="form-group m-4">
                                            <input type="password" name="lpass" class="form-control rounded-pill p-2" placeholder="Password" required>
                                        </div>

                                        <div class="form-group m-4">
                                            <input type="password" name="lpass1" class="form-control rounded-pill p-2" placeholder="Confirm Password" required>
                                                <?php 
                                                if($error1!=null){
